(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["jsplumbchart"] = factory(require("vue"));
	else
		root["jsplumbchart"] = factory(root["Vue"]);
...
var BezierEasing = __webpack_require__("d138")
 ...
 */
var wheel = __webpack_require__("7d67");
var animate = __webpack_require__("7708");
var eventify = __webpack_require__("00c7");
var kinetic = __webpack_require__("e9ff");
var createTextSelectionInterceptor = __webpack_require__("0201");
var domTextSelectionInterceptor = createTextSelectionInterceptor();
var fakeTextSelectorInterceptor = createTextSelectionInterceptor(true);
var Transform = __webpack_require__("408b");
var makeSvgController = __webpack_require__("c327");
var makeDomController = __webpack_require__("5647");
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"82a453dc-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/jsplumbchart/index.vue?vue&type=template&id=500f6116&
...
// CONCATENATED MODULE: ./src/jsplumbchart/index.vue?vue&type=template&id=500f6116&
...
// CONCATENATED MODULE: ./src/jsplumbchart/lib/getInstance.js
// import plumbGather from "jsplumb";
/* harmony default export */ var getInstance = (function (options) {
  // let instance = plumbGather.jsPlumb.getInstance({
  //   Container: options.container
  // });
  var instance = options.jsPlumb.getInstance({
    Container: options.container
  });
  ...
  instance.bind('connectionDetached', function (c) {
    options.delConnections(c, function () {});
  });
  return instance;
});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"82a453dc-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/jsplumbchart/node/flowchatNode/index.vue?vue&type=template&id=42339642&
var flowchatNodevue_type_template_id_42339642_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flowchart-node",attrs:{"id":"flowchartnode"}},_vm._l((_vm.stepData),function(data,index){return _c('div',{key:index,class:'designIconBig '+_vm.setClass(_vm.nodeClass(data.type)),style:('left:'+data.x+'px;top:'+data.y+'px;position:absolute;margin:0'),attrs:{"id":data.id,"data-sign":data.name,"data-type":data.type},on:{"dblclick":function($event){return _vm.dblClick(data)}}},[_c('i',{staticClass:"icon iconfont icon-ir-designIconBg designIconBg"}),_c('i',{class:_vm.nodeIcon(data.type) == 'iconTrue'?'icon iconfont icon-ir-d-'+data.type:'icon iconfont icon-ir-d-default',attrs:{"id":"changeSte"}}),_c('h4',{attrs:{"title":data.name}},[_vm._v(_vm._s(data.name))]),_c('h5',[_vm._v("ID:"+_vm._s(data.id))]),_c('em',{staticClass:"icon iconfont icon-ir-copy",attrs:{"id":"copeDes","title":"复制"},on:{"click":function($event){$event.preventDefault();return _vm.copyNode(data)}}}),_c('em',{staticClass:"fa fa-trash-o",attrs:{"id":"removeDes","title":"删除"},on:{"click":function($event){return _vm.delNode(data.id)}}}),_c('div',{directives:[{name:"show",rawName:"v-show",value:(data.type=='split'),expression:"data.type=='split'"}],staticClass:"line-split",style:(_vm.setLineSplit(data))})])}),0)}
var flowchatNodevue_type_template_id_42339642_staticRenderFns = []


// CONCATENATED MODULE: ./src/jsplumbchart/node/flowchatNode/index.vue?vue&type=template&id=42339642&

// EXTERNAL MODULE: ./node_modules/core-js/modules/es.string.replace.js
var es_string_replace = __webpack_require__("5319");

// CONCATENATED MODULE: ./src/jsplumbchart/lib/flowchart.js
...
var flowchart_addEndpointToNode = function addEndpointToNode(jsplumbInstance, self, steps, flowData, _) {
  jsplumbInstance.deleteEveryEndpoint();
  self.$nextTick(function () {
    steps.forEach(function (data, index) {
      ...
      if (nodeClass(drawType) == 'classD_A') {
        ...
        //return;
        var anchors = addMultioutput(getOutputConfigurations(data.outputConfigurations, _)); // console.log("data", data);
        ...
        _.forEach(anchors, function (val, index) {
        ...
        jsplumbInstance.addEndpoint(dataIndex, {
          ...
          uuid: dataIndex + 'input' + 'destination'
        }, destination)); // jsplumbInstance.addEndpoint(
        //   dataIndex,
        //   { anchors: "LeftMiddle" },
        ...
        jsplumbInstance.addEndpoint(dataIndex, {
          anchors: 'LeftMiddle',
          maxConnections: drawType == 'sql' ? -1 : 1
        }, _objectSpread2({
          uuid: dataIndex + 'input' + 'destination'
        }, destination));
      }
      ...
      jsplumbInstance.draggable(dataIndex, {
        // containment: 'parent',
        start: function start(params) {// 拖动开始
          // console.log(params);
          //console.log("拖动开始");
        },
        drag: function drag(params) {// 拖动中
        },
        stop: function stop(params) {
          var top = params.el.style.top;
          var left = params.el.style.left; // 拖动结束
          // console.log("拖动介绍");
...
var getOutputConfigurations = function getOutputConfigurations(val, _) {
  var result = [];
...
var addMultioutput = function addMultioutput(list) {
...
var connect = function connect(jsplumbInstance, self, links, connectCallback) {
  self.$nextTick(function () {
    //节点之间连线
...
var getNodeType = function getNodeType(drawType) {
  if (nodeClass(drawType) == 'classD_A') {
    return 'RightMiddle1';
  } else if (nodeClass(drawType) == 'classD_B') {
    return 'LeftMiddle1';
...
var filterLinkData = function filterLinkData(data, _) {
...
var message = function message(_message, callback, self) {
  self.$confirm(_message, '提示', {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/jsplumbchart/node/flowchatNode/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var flowchatNodevue_type_script_lang_js_ = ({
  watch: {
  ...
  methods: {
    ...
    copyNode: function copyNode(val) {
      this.$emit("copyNode", val);
    },
    setLineSplit: function setLineSplit(step) {
      if (step.type == "split") {
        var outputConfigurations = lodash_default.a.toArray(step.outputConfigurations);
...
// CONCATENATED MODULE: ./src/jsplumbchart/node/flowchatNode/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var node_flowchatNodevue_type_script_lang_js_ = (flowchatNodevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/jsplumbchart/node/flowchatNode/index.vue?vue&type=style&index=0&lang=scss&
var flowchatNodevue_type_style_index_0_lang_scss_ = __webpack_require__("7596");
...
// CONCATENATED MODULE: ./src/jsplumbchart/node/flowchatNode/index.vue
...
var component = normalizeComponent(
  node_flowchatNodevue_type_script_lang_js_,
  flowchatNodevue_type_template_id_42339642_render,
  flowchatNodevue_type_template_id_42339642_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var flowchatNode = (component.exports);
// CONCATENATED MODULE: ./src/jsplumbchart/lib/pan.js
...
var panzoom = __webpack_require__("7d05"); // 初始化panzoom插件


function init(instance, shouldIgnore) {
  var mainContainer = instance.getContainer();
  var mainContainerWrap = mainContainer.parentNode;
  var pan = panzoom(mainContainer, {
    smoothScroll: false,
    bounds: false,
    autocenter: true,
    ...
    minZoom: 0.5,
    maxZoom: 2,
    beforeWheel: function beforeWheel(e) {
      return shouldIgnore;
    }
  });
  instance.mainContainerWrap = mainContainerWrap;
  instance.pan = pan; // 缩放时设置jsPlumb的缩放比率

  pan.on('zoom', function (e) {
    var _e$getTransform = e.getTransform(),
        scale = _e$getTransform.scale; // console.log("scale", scale);
...
var getScale = function getScale(instance) {
  ...
  // return scale1;
  var container = _this.jsplumbInstance.getContainer();

  var scale1;

  if (_this.jsplumbInstance.pan) {
    var _this$jsplumbInstance = _this.jsplumbInstance.pan.getTransform(),
        scale = _this$jsplumbInstance.scale;
  ...
  _this.jsplumbInstance.setZoom(scale1);

  return scale1;
};

/* harmony default export */ var pan = (panZoom);

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/jsplumbchart/index.vue?vue&type=script&lang=js&
...
/* harmony default export */ var jsplumbchartvue_type_script_lang_js_ = ({
  watch: {
    data: function data(val) {
  ...
  components: {
    flowchartNode: flowchatNode // cepNode
  ...
  updated: function updated() {
    ...
    this.$nextTick(function () {
      ...
      //   });
      // }
      _this.drawJsplumbChart({
        jsplumbInstance: _this.jsplumbInstance,
        self: _this,
        flowData: _this.stepData,
        links: _this.links
      }, function () {
        _this.getLinksData(); // if (this.isPanZoomInit) {
  ...
  methods: {
    ...
    modifyNodePositon: function modifyNodePositon(val) {
      var jsplumbInstance = this.jsplumbInstance;
      var containerRect = this.containerRect;
      var scale = this.getScale(this.jsplumbInstance);
      var left = (val.x - containerRect.left) / scale;
      var top = (val.y - containerRect.top) / scale;
      left -= 20;
      top -= 25;
      return {
        x: left,
    ...
    canvasMoveTo: function canvasMoveTo(data, fn) {
      // let matrix = data
      //   .split("(")[1]
      //   .split(")")[0]
      //   .split(",");
    ...
    setCavansMatrix: function setCavansMatrix(data) {
      var source = lodash_default.a.filter(data, function (val) {
        return val.type == "source";
      });

      return source[0].stepSettings && source[0].stepSettings.matrix;
    },
    setNodeTemplate: function setNodeTemplate(val) {
      switch (val) {
        case "flowchartnode":
          return flowchatNode;
    ...
    drawJsplumbChart: function drawJsplumbChart(data, connectCallback) {
      ...
      flowchart_addEndpointToNode(data.jsplumbInstance, data.self, data.flowData, function (val) {
        _this2.stepData = lodash_default.a.map(_this2.stepData, function (item) {
          if (item.id == val.id) {
    ...
    delNode: function delNode(val) {
      this.stepData = lodash_default.a.filter(lodash_default.a.cloneDeep(this.stepData), function (item) {
        return item.id != val;
      });
    },
    dblClick: function dblClick(val) {
    ...
    getLinksData: function getLinksData() {
      this.links = filterLinkData(lodash_default.a.map(this.jsplumbInstance.getAllConnections(), function (item) {
        return {
          name: item.id,
...
// CONCATENATED MODULE: ./src/jsplumbchart/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_jsplumbchartvue_type_script_lang_js_ = (jsplumbchartvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/jsplumbchart/index.vue?vue&type=style&index=0&lang=scss&
var jsplumbchartvue_type_style_index_0_lang_scss_ = __webpack_require__("e887");

// CONCATENATED MODULE: ./src/jsplumbchart/index.vue
...
var jsplumbchart_component = normalizeComponent(
  src_jsplumbchartvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var jsplumbchart = (jsplumbchart_component.exports);
// CONCATENATED MODULE: ./src/jsplumbchart/jsplumbchart.js
...
var Components = {
  Jsplumbchart: jsplumbchart
};
Object.keys(Components).forEach(function (name) {
  external_commonjs_vue_commonjs2_vue_root_Vue_default.a.component(name, Components[name]);
});
/* harmony default export */ var jsplumbchart_jsplumbchart = (Components); // export default {
//   install(Vue, options) {
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (jsplumbchart_jsplumbchart);
...
//# sourceMappingURL=jsplumbchart.umd.js.map